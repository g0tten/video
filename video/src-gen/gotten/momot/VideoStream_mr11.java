...
public class VideoStream_mr11 {
  protected final static String INITIAL_MODEL = "model/initial/videotc/videosource10/videosource10.xmi";
  ...
  protected double _createObjectiveHelper_0(final TransformationSolution solution, final EGraph graph, final EObject root) {
    return FitnessFunctionForVideoStream_mr1.getMAxresultsDistance(((VideoAPITest) root), VideoStream_mr11.INITIAL_MODEL);
  }
  ...
  protected SearchAnalyzer performAnalysis(final SearchExperiment<TransformationSolution> experiment) {
    ...
    System.out.println("---------------------------");
    try {
    	System.out.println("- Save Analysis to 'output/videosource10/mr1/analysis/analysis.txt'");
    	searchAnalyzer.saveAnalysis(new File("output/videosource10/mr1/analysis/analysis.txt"));
    } catch(IOException e) {
    	e.printStackTrace();
    }
    System.out.println("- Save Indicator BoxPlots to 'output/videosource10/mr1/analysis/'");
    searchAnalyzer.saveIndicatorBoxPlots(
    	"output/videosource10/mr1/analysis/",
    	baseName
    );
  ...
  protected TransformationResultManager handleResults(final SearchExperiment<TransformationSolution> experiment) {
    ...
    System.out.println("- Save objectives of all algorithms to 'output/videosource10/mr1/objectives/objective_values.txt'");
    TransformationResultManager.saveObjectives(
    	"output/videosource10/mr1/objectives/objective_values.txt",
    	population
    );
    System.out.println("---------------------------");
    ...
    population = 
    	TransformationResultManager.createApproximationSet(experiment, (String[])null);
    System.out.println("- Save solutions of all algorithms to 'output/videosource10/mr1/solutions/objective_values.txt'");
    TransformationResultManager.savePopulation(
    	"output/videosource10/mr1/solutions/objective_values.txt",
    	population,
    	populationWriter
    );
    System.out.println("- Save solutions of all algorithms to 'output/videosource10/mr1/solutions/objective_values.txt'");
    TransformationResultManager.saveSolutions(
    	"output/videosource10/mr1/solutions/",
    	baseName,
    ...
    population = 
    	TransformationResultManager.createApproximationSet(experiment, (String[])null);
    System.out.println("- Save models of all algorithms to 'output/videosource10/mr1/models/'");
    TransformationResultManager.saveModels(
    	"output/videosource10/mr1/models/",
    	baseName,
    	population
    );
  ...
  public static void initialization() {
    ...
    IOUtils.deleteFolder("C:/eclipse/runtime-EclipseApplication8/video/output/videosource10/mr1/models");
  ...
  public static void finalization() {
    ...
    FollowUpUtils.copyModels("C:/eclipse/runtime-EclipseApplication8/video/output/videosource10/mr1/models", "C:/eclipse/runtime-EclipseApplication8/video/model/videotc/videosource10/mr1");
    System.out.println("Copy finished.");
  }
  
  public static void main(final String... args) {
    initialization();
    VideoStream_mr11 search = new VideoStream_mr11();
