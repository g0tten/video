package gotten.YoutubeProcessor.YoutubeProcessorVideostreamingMR2;
...
public class YoutubeProcessorVideostreamingMR2 implements IGottenExecutor {
	...
	public static Map<String, Map<String, SimpleEntry<Boolean, Boolean>>> evaluateMR2() {
		...
		registerMetamorphicResult(results, "MR2",
				"videotc/videosource11.model#videotc/videosource11/mr2/followup_00002.model", true, true);
		registerMetamorphicResult(results, "MR2",
		...
		registerMetamorphicResult(results, "MR2",
				"videotc/videosource26.model#videotc/videosource26/mr2/followup_00002.model", false, true);
		registerMetamorphicResult(results, "MR2",
				"videotc/videosource27.model#videotc/videosource27/mr2/followup_00002.model", true, true);
		registerMetamorphicResult(results, "MR2",
				"videotc/videosource28.model#videotc/videosource28/mr2/followup_00002.model", true, true);
		registerMetamorphicResult(results, "MR2",
				"videotc/videosource29.model#videotc/videosource29/mr2/followup_00002.model", true, true);
		registerMetamorphicResult(results, "MR2",
				"videotc/videosource3.model#videotc/videosource3/mr2/followup_00002.model", true, true);
		registerMetamorphicResult(results, "MR2",
				"videotc/videosource30.model#videotc/videosource30/mr2/followup_00002.model", false, true);
		registerMetamorphicResult(results, "MR2",
				"videotc/videosource4.model#videotc/videosource4/mr2/followup_00002.model", true, true);
		registerMetamorphicResult(results, "MR2",
