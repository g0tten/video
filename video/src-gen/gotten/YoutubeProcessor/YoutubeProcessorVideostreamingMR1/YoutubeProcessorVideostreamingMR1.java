package gotten.YoutubeProcessor.YoutubeProcessorVideostreamingMR1;
...
public class YoutubeProcessorVideostreamingMR1 implements IGottenExecutor {
	...
	public static Map<String, Map<String, SimpleEntry<Boolean, Boolean>>> evaluateMR1() {
		...
		registerMetamorphicResult(results, "MR1",
				"videotc/videosource22.model#videotc/videosource22/mr1/followup_00003.model", true, true);
		registerMetamorphicResult(results, "MR1",
				"videotc/videosource22.model#videotc/videosource22/mr1/followup_00004.model", true, true);
		registerMetamorphicResult(results, "MR1",
		...
		registerMetamorphicResult(results, "MR1",
				"videotc/videosource27.model#videotc/videosource27/mr1/followup_00002.model", true, true);
		registerMetamorphicResult(results, "MR1",
				"videotc/videosource27.model#videotc/videosource27/mr1/followup_00003.model", true, true);
		registerMetamorphicResult(results, "MR1",
				"videotc/videosource27.model#videotc/videosource27/mr1/followup_00004.model", true, true);
		registerMetamorphicResult(results, "MR1",
				"videotc/videosource28.model#videotc/videosource28/mr1/followup_00002.model", true, true);
		registerMetamorphicResult(results, "MR1",
				"videotc/videosource28.model#videotc/videosource28/mr1/followup_00003.model", true, true);
		registerMetamorphicResult(results, "MR1",
				"videotc/videosource28.model#videotc/videosource28/mr1/followup_00004.model", true, true);
		registerMetamorphicResult(results, "MR1",
				"videotc/videosource29.model#videotc/videosource29/mr1/followup_00002.model", true, true);
		registerMetamorphicResult(results, "MR1",
				"videotc/videosource29.model#videotc/videosource29/mr1/followup_00003.model", true, true);
		registerMetamorphicResult(results, "MR1",
				"videotc/videosource29.model#videotc/videosource29/mr1/followup_00004.model", true, true);
		registerMetamorphicResult(results, "MR1",
		...
		registerMetamorphicResult(results, "MR1",
				"videotc/videosource6.model#videotc/videosource6/mr1/followup_00003.model", true, true);
		registerMetamorphicResult(results, "MR1",
				"videotc/videosource6.model#videotc/videosource6/mr1/followup_00004.model", true, true);
		registerMetamorphicResult(results, "MR1",
				"videotc/videosource7.model#videotc/videosource7/mr1/followup_00002.model", true, true);
		registerMetamorphicResult(results, "MR1",
				"videotc/videosource7.model#videotc/videosource7/mr1/followup_00003.model", true, true);
		registerMetamorphicResult(results, "MR1",
				"videotc/videosource7.model#videotc/videosource7/mr1/followup_00004.model", true, true);
		registerMetamorphicResult(results, "MR1",
				"videotc/videosource8.model#videotc/videosource8/mr1/followup_00002.model", true, true);
		registerMetamorphicResult(results, "MR1",
				"videotc/videosource8.model#videotc/videosource8/mr1/followup_00003.model", true, true);
		registerMetamorphicResult(results, "MR1",
