...
import rest.VideoStreamExecutor;
	...
	public int execute(List<Resource> models) {
		...
		for (Resource model : models) {
			...
			try {
				...
				args[1] = "C:/eclipse/runtime-EclipseApplication8/video/model/VideoStream.ecore";
				...
				args[2] = model.getURI().toFileString();
